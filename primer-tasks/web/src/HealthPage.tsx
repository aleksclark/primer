...
export default function HealthPage() {
  ...
  return <>
    <header className="page-header">
      <div><p className="eyebrow">Parent workspace / Operate</p><h1>Tasks service health</h1><p>This is the server-owned health contract. Verifier catalog and delivery health will appear here only when the Tasks API exposes those contracts.</p></div>
