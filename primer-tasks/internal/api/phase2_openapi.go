...
func (s *Server) registerPhase2(api huma.API) {
	...
	register(api, huma.Operation{OperationID: "occurrence-retry", Method: http.MethodPost, Path: "/occurrences/{id}/retry", Errors: []int{400, 401, 404, 409, 500}, SkipValidateBody: true}, func(ctx context.Context, _ *OccurrenceRetryInput2) (*OccurrenceRetryOutput2, error) {
