...
type OccurrenceActionOutput2 struct {
	ResponseHeaders
	Body OccurrenceAction2
}

type OccurrenceDecisionOutput2 struct {
	ResponseHeaders
	Body OccurrenceDecision2
}

type OccurrenceRetryOutput2 struct {
	ResponseHeaders
	Body OccurrenceRetry2
}
...
func (s *Server) registerPhase2(api huma.API) {
	...
	register(api, huma.Operation{OperationID: "schedules-update", Method: http.MethodPatch, Path: "/schedules/{id}", Errors: []int{400, 401, 404, 409, 500}, SkipValidateBody: true, SkipValidateParams: true}, func(ctx context.Context, in *ScheduleUpdateEnvelope2) (*ScheduleOutput2, error) {
		b, h, e := legacyJSON[Schedule2](ctx, s.requireParent(s.updateSchedule2), in.Body)
		return &ScheduleOutput2{h, b}, e
	})
	...
	register(api, huma.Operation{OperationID: "occurrence-approve", Method: http.MethodPost, Path: "/occurrences/{id}/decision", Errors: []int{400, 401, 409, 500}, SkipValidateBody: true}, func(ctx context.Context, in *DecisionInputEnvelope2) (*OccurrenceDecisionOutput2, error) {
		b, h, e := legacyJSON[OccurrenceDecision2](ctx, s.requireParent(s.decideOccurrence2), in.Body)
		return &OccurrenceDecisionOutput2{h, b}, e
	})
	register(api, huma.Operation{OperationID: "occurrence-retry", Method: http.MethodPost, Path: "/occurrences/{id}/retry", Errors: []int{400, 401, 404, 409, 500}, SkipValidateBody: true, SkipValidateParams: true}, func(ctx context.Context, _ *OccurrenceIDInput2) (*OccurrenceRetryOutput2, error) {
		b, h, e := legacyJSON[OccurrenceRetry2](ctx, s.requireParent(s.retryOccurrence2), nil)
		return &OccurrenceRetryOutput2{h, b}, e
	})
	register(api, huma.Operation{OperationID: "occurrence-skip", Method: http.MethodPost, Path: "/occurrences/{id}/skip", Errors: []int{400, 401, 404, 409, 500}, SkipValidateBody: true, SkipValidateParams: true}, func(ctx context.Context, _ *OccurrenceIDInput2) (*OccurrenceActionOutput2, error) {
		b, h, e := legacyJSON[OccurrenceAction2](ctx, s.requireParent(func(w http.ResponseWriter, r *http.Request, sc scope) { s.setOccurrenceStatus2(w, r, sc, "excused") }), nil)
		return &OccurrenceActionOutput2{h, b}, e
	})
	register(api, huma.Operation{OperationID: "occurrence-cancel", Method: http.MethodPost, Path: "/occurrences/{id}/cancel", Errors: []int{400, 401, 404, 409, 500}, SkipValidateBody: true, SkipValidateParams: true}, func(ctx context.Context, _ *OccurrenceIDInput2) (*OccurrenceActionOutput2, error) {
		b, h, e := legacyJSON[OccurrenceAction2](ctx, s.requireParent(func(w http.ResponseWriter, r *http.Request, sc scope) { s.setOccurrenceStatus2(w, r, sc, "canceled") }), nil)
		return &OccurrenceActionOutput2{h, b}, e
	})
