...
// the primer-agents process boundary.
package logging
...
// postgresURIInText matches postgres/postgresql URIs embedded in diagnostic text.
...
// useful diagnostic context (e.g. "connection refused", "migrate:").
