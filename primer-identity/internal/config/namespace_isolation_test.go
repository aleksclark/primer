...
var prefixedIdentityKeys = []string{
	...
	"IDENTITY_CLIENT_SECRET_PEPPERS",
	"IDENTITY_CLIENT_SECRET_ACTIVE_VERSION",
	"IDENTITY_REFRESH_TOKEN_PEPPERS",
	"IDENTITY_REFRESH_TOKEN_ACTIVE_VERSION",
	"IDENTITY_CLIENT_ASSERTION_PEPPERS",
	"IDENTITY_CLIENT_ASSERTION_ACTIVE_VERSION",
...
var hostileBareEnv = map[string]string{
	...
	"KEY_ENABLED":                   "true",
	"KEY_AUTO_BOOTSTRAP":            "true",
	"KEY_SEAL_SECRET":               hostileBareSecret,
	"SEAL_SECRET":                   hostileBareSecret,
}
