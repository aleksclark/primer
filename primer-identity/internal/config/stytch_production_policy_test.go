	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			for key, value := range map[string]string{
				...
				"IDENTITY_CLIENT_SECRET_PEPPERS": "1:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "IDENTITY_CLIENT_SECRET_ACTIVE_VERSION": "1",
				"IDENTITY_REFRESH_TOKEN_PEPPERS": "1:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "IDENTITY_REFRESH_TOKEN_ACTIVE_VERSION": "1",
				"IDENTITY_CLIENT_ASSERTION_PEPPERS": "1:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "IDENTITY_CLIENT_ASSERTION_ACTIVE_VERSION": "1",
