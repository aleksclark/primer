...
| [09: IB5 / Primer-owned service principals](./phase-09-refresh-revoke-logout.md) | **Current implementation wave.** Add bounded local machine credentials and `client_credentials`; fresh exact-tip security review remains required. | IB2. |
