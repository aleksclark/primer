...
| [08: IB4 / signed webhook and two-plane revocation](./phase-08-service-principals.md) | **Current wave.** Make provider invalidation and local grants durable and replay safe, with four reason-bound collision classes and one restart-safe alert. | IB1–IB3; hard gate for production BFF/MCP. |
