...
| **D5** | Plan graph + publish consistency — **next** | Database | [phase-05](../curriculum-studio-database/phase-05-plan-graph-and-publication.md) | D4 | PG4b | `impl/D5-plan-graph` | G-studio-test; P5-E1–P5-E5 with real PostgreSQL and concurrent cycle contention | — |
