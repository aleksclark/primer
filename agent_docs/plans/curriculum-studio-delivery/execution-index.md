...
| **D7** | Learner snapshots + mat runs — **next** | Database | [phase-07](../curriculum-studio-database/phase-07-learner-snapshots-and-runs.md) | D5 | PG5c | `impl/D7-mat-runs` | G-studio-test; P7-E1–P7-E3 with real PostgreSQL and fingerprint contention | parallel D6 OK |
