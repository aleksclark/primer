...
**Contracts status:** C1–C6 are complete on current master; C4 landed in PR #28 (`db587ed`), C5 in PR #31 (`b35164d`), and C6 in PR #36 (`eb2fd8c`). **Contracts cursor: C7** (OpenAPI handoff and REST clients).
...
| **C7** | OpenAPI baseline handoff + REST clients — **current** | Contracts | [phase-07](../curriculum-studio-contracts/phase-07-openapi-handoff-and-rest-clients.md) | C6 | PG5d | `impl/C7-openapi-clients` | TS/Go clients gen | stop dual SoT |
