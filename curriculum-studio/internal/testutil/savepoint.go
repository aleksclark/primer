...
// SavepointQuerier wraps a transaction so every statement runs inside a
// savepoint. Expected constraint violations roll back to the savepoint instead
// of aborting the outer test transaction.
...
// Query runs a query inside a savepoint.
...
// QueryRow runs a single-row query inside a savepoint.
