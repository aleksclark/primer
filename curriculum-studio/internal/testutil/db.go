...
// a PostgreSQL testcontainer (or TEST_DATABASE_URL) migrated with the Studio
// migrator, plus per-test transaction rollback and savepoint wrappers.
//
// Pattern mirrors server/internal/testutil but is Studio-owned and never
// applies LMS migrations.
package testutil
...
// testcontainer (or TEST_DATABASE_URL if set).
